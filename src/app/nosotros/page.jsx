  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.section_two}>
        ...
        <div className={styles.line_2}>Despertar admiración en nuestra comunidad</div>
      ...
      <div className={styles.section_four}>
        ...
        <div className={styles.description}>
          Nos esforzamos por construir una mejor empresa a través de 
          nuestras acciones y decisiones diarias. Descubre cómo 
          nuestros valores corporativos dan forma a todo lo que hacemos.
        </div>
      </div>
      <div className={styles.section_five}>
        <div className={styles.title}>INNOVACIÓN</div>
        <div className={styles.description}>
          Con la idea de llegar al corazón y quedarnos en la mente, 
          nos reinventamos todo el tiempo con la creación de nuevos platos 
          y la mezcla de diferentes ingredientes que juntos forman una 
          sinfonía capaz de cautivar los paladares más conocedores y los 
